            ...
            <div className={styles['detail-2']}>
              ...
              <div className={styles['description']}>
                ...
                <p>
                  ...
                  제작되어, 프로젝트의 효율성과 코드의 재사용성을 높였습니다.
                </p>
                <p>
          ...
          <div className={styles['page-container']}>
            ...
            <div className={styles['search-1']}>
              ...
              <div className={styles['description']}>
                ...
                <p>
                  검색 데이터 수집을 위해 검색 링크를 검색 데이터로 이루어진
                  쿼리 파라미터로 구성하고 해당 키워드를 서버로 전송하여
                  서버에서는 구현된 비즈니스 로직을 통해 처리된 결과 데이터를
                  보내줍니다. 이후, 받아온 결과 데이터를 기반으로 검색 페이지를
                  동적으로 구성하였습니다.
                </p>
              </div>
            </div>
