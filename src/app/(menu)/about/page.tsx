        ...
        <div className={styles['content-container']}>
          ...
          <div className={styles['about-content-container']}>
            ...
            <p className={styles['about-content']}>
              ...
              찾지 못했던 탓입니다. 그러던 와중 웹 개발, 특히 프론트엔드라는 분야를 처음으로 접하게
              된 것은 제 인생에 있어서 큰 행운이었다고 생각합니다. 저는 평소에 생각이 많은 편입니다.
              프론트엔드 개발은 이러한 저의 성향을 가치 있는 방향으로 활용할 수 있게끔 해주었습니다.
              또한, 결과물들을 눈으로 확인시켜 주며 큰 즐거움과 성취감까지 주는 분야가 되었습니다.
              이렇게 탄생한 결과물들이 사람들에게 도움이 되는 가치를 가질 수 있다는 점은 또 하나의
              큰 동기부여가 되어, 하루하루 프론트엔드 개발자가 되기 위해 노력하고 있습니다.
            </p>
            <div className={styles['resume-link-container']}>
              <a
                href="https://acrobat.adobe.com/id/urn:aaid:sc:AP:5aa4a504-064d-4646-92bc-a16158b405d5"
                target="_blank"
