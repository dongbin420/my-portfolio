        ...
        <div className={styles['content-container']}>
          ...
          <div className={styles['about-content-container']}>
            ...
            <p className={styles['about-content']}>
              ...
              된 것은 제 인생에 있어서 큰 행운이었다고 생각합니다. 평소에 생각이 많고, 깊은 생각을
              통해 문제를 해결하는 과정을 좋아합니다. 프론트엔드 개발은 이러한 저의 성향을 웹을 통해
              실현해 주고, 눈으로 확인시켜 주며 큰 즐거움과 뿌듯한 성취감까지 주는 분야가
              되었습니다. 이렇게 탄생한 결과물들이 사람들에게 도움이 되는 비즈니스적인 가치를 가질
              수 있다는 점은 또 하나의 큰 동기부여가 되어, 하루하루 프론트엔드 개발자가 되기 위해
              노력하고 있습니다.
            </p>
